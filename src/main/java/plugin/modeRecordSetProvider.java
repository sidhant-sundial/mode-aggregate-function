...
public class modeRecordSetProvider
        implements ConnectorRecordSetProvider
{
    ...
    @Inject
    public modeRecordSetProvider(modeConfig config, modeMetadata metadata)
    {
    ...
    {
        List<modeColumnHandle> columnHandles = list.stream()
                .map(c -> (modeColumnHandle) c)
                .collect(toList());
